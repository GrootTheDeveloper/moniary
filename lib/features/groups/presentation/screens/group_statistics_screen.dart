          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  budget.hasLimit
                      ? '${formatVnd(stats.totalSpent)} / ${formatVnd(budget.monthlyLimit)}'
        ...
        ...stats.memberBreakdown.map(
          (item) => Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                'Chịu ${formatVnd(item.shareAmount)} • Đã trả ${formatVnd(item.paidAmount)}',
              ),
              trailing: Text(formatVnd(item.balance)),
            ),
          ),
        ),
      ],
