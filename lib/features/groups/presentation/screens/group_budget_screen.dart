        ...
        actions:
            ...
            ? [
                IconButton(
                  ...
                  onPressed: () =>
                      _showEditSheet(context, ref, budgetAsync.value),
  ...
  void _showEditSheet(
    ...
    showModalBottomSheet<void>(
      ...
      builder: (sheetContext) =>
          _EditBudgetSheet(groupId: groupId, current: current),
    );
  }
}
...
class _EditBudgetSheetState extends ConsumerState<_EditBudgetSheet> {
  ...
  void initState() {
    ...
    _limitController = TextEditingController(
      text: (widget.current?.monthlyLimit ?? 0).toString(),
    );
            ...
            Column(
              ...
              children: [
                ...
                Slider(
                  ...
                  divisions: 99,
                  onChanged: (value) =>
                      setState(() => _warningPercent = value.toInt()),
                ),
              ],
            ),
            const SizedBox(height: 24),
  ...
  Future<void> _submit() async {
    ...
    if (limit < 0) {
      messenger.showSnackBar(
        SnackBar(content: Text(context.l10n.groupBudgetInvalidAmount)),
      );
      return;
    }
