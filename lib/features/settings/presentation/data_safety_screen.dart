        ...
        child: ListView(
          ...
          children: const [
            _DataSafetyCard(
              ...
              description: 'Tên hiển thị, email, avatar và user ID dùng cho đăng nhập và đồng bộ dữ liệu.',
            ),
            _DataSafetyCard(
              icon: Icons.account_balance_wallet_outlined,
              title: 'Financial info',
              status: 'Có',
              description: 'Ví, danh mục, số tiền, ghi chú và ngày giao dịch do người dùng nhập.',
            ),
            _DataSafetyCard(
              icon: Icons.photo_camera_outlined,
              title: 'Photos',
              status: 'Có, khi người dùng chủ động chọn/chụp',
              description: 'Ảnh giao dịch được lưu trong private storage và chỉ hiển thị qua signed URL.',
            ),
            _DataSafetyCard(
              icon: Icons.fingerprint_rounded,
              title: 'User ID',
              status: 'Có',
              description: 'Dùng để gắn dữ liệu với đúng tài khoản và áp dụng RLS trên Supabase.',
            ),
            _DataSafetyCard(
              icon: Icons.location_off_outlined,
              title: 'Location, Contacts, SMS',
              status: 'Không thu thập trong MVP',
              description: 'Moniary không xin quyền vị trí, danh bạ hoặc đọc SMS/email để import giao dịch.',
            ),
          ],
        ),
      ),
