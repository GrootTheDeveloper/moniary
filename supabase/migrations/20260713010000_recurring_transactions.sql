...
-- A rule repeatedly produces income/expense transactions (subscriptions,
-- salary, rent, loan payments). Auto-post rules are materialized into the
-- `transactions` table by the client; all rules drive reminders and
