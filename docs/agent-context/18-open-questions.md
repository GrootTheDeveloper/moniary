...
| Where will the OCR API be hosted for production? | The integrated FastAPI backend currently targets local Ollama and needs a reachable HTTPS deployment for release builds. | `backend/ocr/`, `fast_api_ocr_service.dart` | AI / Backend Team |
