...
| Does email/guest login satisfy iOS App Review Guideline 4.8 alongside Google/Facebook? | Social login for a primary account requires an equivalent privacy-focused alternative unless an exception applies. | Auth UX and App Review submission notes; Product/Legal/Mobile. |
