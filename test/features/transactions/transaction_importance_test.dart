...
void main() {
  ...
  group('TransactionRepository - Importance tests (Mock Mode)', () {
    test('creates transaction with isImportant set to false by default', () async {
    ...
    test('creates transaction with isImportant set to true explicitly', () async {
      final id = await repository.createTransaction(
        amount: 1500000,
        type: TransactionType.expense,
        walletId: 'wallet-1',
  ...
  group('TransactionComposerController - Importance integration tests (Mock Mode)', () {
    test('creates transaction with isImportant via TransactionComposerController', () async {
      ...
      final controller = container.read(transactionComposerProvider.notifier);
    ...
    test('updates transaction with isImportant via TransactionComposerController', () async {
      final id = await repository.createTransaction(
        amount: 10000,
        type: TransactionType.expense,
        walletId: 'wallet-1',
